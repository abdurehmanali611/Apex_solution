    ...
    <section className="section-padding px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-4 mb-14">
          ...
          {/* AI badge */}
          <div className="inline-flex flex-wrap items-center gap-2 px-4 py-2 rounded-full bg-blue-600/10 border border-blue-500/20 w-fit max-w-full mt-1">
            <Brain className="w-3.5 h-3.5 text-blue-400 shrink-0" />
            <span className="text-xs font-semibold text-blue-300 text-pretty">AI as a Service — built into every engagement</span>
